...
<div style="display:flex; flex-direction: row">
<MiniCard imageSrc={${betting101}} cardText={$500 Risk-Free Bet + $500 Deposit Bonus} />
<MiniCard imageSrc={${finger}} cardText={Up to $250 Deposit Bonus} />
</div>
...
<div style="display:flex; flex-direction: row">
<MiniCard imageSrc={${playerSrc}} cardText={Tom's gone} iconType={1} miniText={Insights} />
<MiniCard imageSrc={${youtubeSrc}} cardText={Using Implied Probability to Make Your Bets} iconType={1} miniText={Insights}/>
</div>
`;
